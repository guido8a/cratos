                    ...
                    if(departamento == '-1'){
                        ...
                        $.ajax({
                            ...
                            success: function (msg){
                                if(msg == 'ok'){
                                    url = "${g.createLink(controller:'reportes2' , action: 'costoVentas')}?cont=" + cont + "Wemp=${session.empresa.id}" + "Wdesde=" + fechaDesde + "Whasta=" + fechaHasta + "Wbodega=" + bodega + "Wdepartamento=" + departamento;
