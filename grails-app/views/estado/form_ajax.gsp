    ...
    <g:form class="form-horizontal" name="frmEstado" role="form" action="save_ajax" method="POST">
        ...
        <div class="form-group ${hasErrors(bean: estadoInstance, field: 'codigo', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-3">
                    <g:textField name="codigo" maxlength="1" class="allCaps form-control required" value="${estadoInstance?.codigo}"/>
                </div>
        ...
        <div class="form-group ${hasErrors(bean: estadoInstance, field: 'descripcion', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="descripcion" maxlength="63" class="form-control required" value="${estadoInstance?.descripcion}"/>
                </div>
