...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'ordenCompora.label', default: 'OrdenCompra')}"/>
    ...
    <body>
        <a href="#create-ordenCompra" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
        ...
        <div id="create-ordenCompra" class="content scaffold-create" role="main">
            ...
            <g:form name="form-ordenCompra" action="save">
                <div class="contenedor">
                    <fieldset style="margin: 10px;">
                        ...
                        <div class="span-20">
                            ...
                            <div class="span-6">
                                <g:select from="${cratos.inventario.CentroCosto.findAllByEmpresa(session.empresa, [sort: 'nombre'])}" name="centroCosto.id" class="required span-6 ui-widget-content ui-corner-all"
                                          value="" style="width: 100px" optionKey="id" optionValue="nombre"/>
                            </div>
                        ...
                        <div class="span-20">
                            ...
                            <div class="span-6">
                                <g:select from="${['N': 'No registrado', 'R': 'Registrado']}" name="estado" class="required span-6 ui-widget-content ui-corner-all" value="" style="width: 100px"
                    ...
                    <fieldset style="margin: 10px;">
                        ...
                        <table class="bg">
                            ...
                            <tr>
                                ...
                                <td id="tdPrecio">
                                    <input type="number" class="ui-widget-content ui-corner-all updatable" id="txtPrecio" disabled="disabled"
