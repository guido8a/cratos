...
class Persona {
    ...
    static constraints = {
        ...
        login(size: 1..25, blank: true, nullable: true, unique: true, attributes: [title: 'Nombre de usuario'])
        password(size: 1..64, blank: true, nullable: true, password: true, attributes: [title: 'Contraseña para el ingreso al sistema'])
        autorizacion(size: 1..255, blank: true, nullable: true, password: true, attributes: [title: 'Contraseña para autorizaciones'])
